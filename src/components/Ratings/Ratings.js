...
import { PieChart } from "../../assets/Charts";
...
export const Ratings = (props) => {
  ...
  if (workersList.length > 0) {
    ...
    let totalsObj = { rating: "Total Workers", qty: total, pct: "100" };
    ...
    let pieData = ratingsFinal.filter((item) => {
      return item.rating !== "Total Workers";
    });
    ...
    const ratingsData = {
      labels: pieData.map((data) => {
        return data.rating === null
          ? "Unavailable Rating"
          : ` ${data.rating} Star Workers`;
      }),
      datasets: [
        {
          label: "Worker Ratings",
      ...
      <div className="row d-flex d-inline-flex justify-content-between w-100">
        ...
        <div className="col">
          <div className="row d-flex flex-column justify-content-between">
            ...
            <div className="col text-center">
              <h2 className="mb-4">Worker Ratings Table</h2>
              ...
              <table className="table table-bordered border-dark text-center">
                <thead className="table-dark">
                  ...
                  <tr>
                    <th scope="col">
                      <h3 className="m-0">Star Rating</h3>
                    </th>
                    <th scope="col">
                ...
                <tbody>
                  ...
                  {ratingsFinal.map((item, i) => {
                    return item.rating === null ? (
                      <tr key={i}>
                        <th scope="row">
                          <h3 className="m-0">Unavailable Rating</h3>
                        </th>
                        <td>
                    ...
                    ) : item.rating === "Total Workers" ? (
                      <tr
                        key={i}
                        style={{ background: "rgba(107, 107, 107, 0.35)" }}
                      >
                        <th scope="row">
                          <h3 className="m-0">{item.rating}</h3>
                        </th>
                        <td>
                          <h3 className="m-0">{item.qty}</h3>
                        </td>
                      ...
                      <tr key={i}>
                        <th scope="row">
                          <h3 className="m-0">{`${item.rating} Star Workers`}</h3>
                        </th>
                        <td>
                          <h3 className="m-0">{item.qty}</h3>
                        </td>
        ...
        <div className="col">
          <div className="row">
            ...
            <div className="col text-center">
              <h2 className="mb-3">Worker Ratings Chart</h2>
